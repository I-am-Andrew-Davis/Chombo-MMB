...
void HDF5Handle::initialize()
{
  ...
  */
...
#if CH_SPACEDIM == 1
  H5Tinsert (intvect_id, "intvecti", CHOFFSET(d1, dataPtr()[0]), H5T_NATIVE_INT);
  H5Tinsert (box_id, "lo_i", CHOFFSET(d3, smallend.dataPtr()[0]), H5T_NATIVE_INT);
  H5Tinsert (box_id, "hi_i", CHOFFSET(d3, bigend.dataPtr()[0]),   H5T_NATIVE_INT);
  H5Tinsert (realvect_id, "x", CHOFFSET(d2, dataPtr()[0]),   H5T_NATIVE_REAL);
#elif CH_SPACEDIM == 2
  H5Tinsert (intvect_id, "intvecti", CHOFFSET(d1, dataPtr()[0]), H5T_NATIVE_INT);
  H5Tinsert (intvect_id, "intvectj", CHOFFSET(d1, dataPtr()[0])+sizeof(int), H5T_NATIVE_INT);
  H5Tinsert (box_id, "lo_i", CHOFFSET(d3, smallend.dataPtr()[0]), H5T_NATIVE_INT);
  H5Tinsert (box_id, "lo_j", CHOFFSET(d3, smallend.dataPtr()[0])+sizeof(int), H5T_NATIVE_INT);
  H5Tinsert (box_id, "hi_i", CHOFFSET(d3, bigend.dataPtr()[0]),   H5T_NATIVE_INT);
  H5Tinsert (box_id, "hi_j", CHOFFSET(d3, bigend.dataPtr()[0])+sizeof(int),   H5T_NATIVE_INT);
  H5Tinsert (realvect_id, "x", CHOFFSET(d2, dataPtr()[0]),   H5T_NATIVE_REAL);
  H5Tinsert (realvect_id, "y", CHOFFSET(d2, dataPtr()[0])+sizeof(Real),   H5T_NATIVE_REAL);
#elif CH_SPACEDIM == 3
  H5Tinsert (intvect_id, "intvecti", CHOFFSET(d1, dataPtr()[0]), H5T_NATIVE_INT);
  H5Tinsert (intvect_id, "intvectj", CHOFFSET(d1, dataPtr()[0])+sizeof(int), H5T_NATIVE_INT);
  H5Tinsert (intvect_id, "intvectk", CHOFFSET(d1, dataPtr()[0])+2*sizeof(int), H5T_NATIVE_INT);
  H5Tinsert (box_id, "lo_i", CHOFFSET(d3, smallend.dataPtr()[0]), H5T_NATIVE_INT);
  H5Tinsert (box_id, "lo_j", CHOFFSET(d3, smallend.dataPtr()[0])+sizeof(int), H5T_NATIVE_INT);
  H5Tinsert (box_id, "lo_k", CHOFFSET(d3, smallend.dataPtr()[0])+2*sizeof(int), H5T_NATIVE_INT);
  H5Tinsert (box_id, "hi_i", CHOFFSET(d3, bigend.dataPtr()[0]),   H5T_NATIVE_INT);
  H5Tinsert (box_id, "hi_j", CHOFFSET(d3, bigend.dataPtr()[0])+sizeof(int),   H5T_NATIVE_INT);
  H5Tinsert (box_id, "hi_k", CHOFFSET(d3, bigend.dataPtr()[0])+2*sizeof(int),   H5T_NATIVE_INT);
  H5Tinsert (realvect_id, "x", CHOFFSET(d2, dataPtr()[0]),   H5T_NATIVE_REAL);
  H5Tinsert (realvect_id, "y", CHOFFSET(d2, dataPtr()[0])+sizeof(Real),   H5T_NATIVE_REAL);
  H5Tinsert (realvect_id, "z", CHOFFSET(d2, dataPtr()[0])+2*sizeof(Real),   H5T_NATIVE_REAL);
#elif CH_SPACEDIM == 4
  H5Tinsert (intvect_id, "intvecti", CHOFFSET(d1, dataPtr()[0]), H5T_NATIVE_INT);
  H5Tinsert (intvect_id, "intvectj", CHOFFSET(d1, dataPtr()[0])+sizeof(int), H5T_NATIVE_INT);
  H5Tinsert (intvect_id, "intvectk", CHOFFSET(d1, dataPtr()[0])+2*sizeof(int), H5T_NATIVE_INT);
  H5Tinsert (intvect_id, "intvectl", CHOFFSET(d1, dataPtr()[0])+3*sizeof(int), H5T_NATIVE_INT);
  H5Tinsert (box_id, "lo_i", CHOFFSET(d3, smallend.dataPtr()[0]), H5T_NATIVE_INT);
  H5Tinsert (box_id, "lo_j", CHOFFSET(d3, smallend.dataPtr()[0])+sizeof(int), H5T_NATIVE_INT);
  H5Tinsert (box_id, "lo_k", CHOFFSET(d3, smallend.dataPtr()[0])+2*sizeof(int), H5T_NATIVE_INT);
  H5Tinsert (box_id, "lo_l", CHOFFSET(d3, smallend.dataPtr()[0])+3*sizeof(int), H5T_NATIVE_INT);
  H5Tinsert (box_id, "hi_i", CHOFFSET(d3, bigend.dataPtr()[0]),   H5T_NATIVE_INT);
  H5Tinsert (box_id, "hi_j", CHOFFSET(d3, bigend.dataPtr()[0])+sizeof(int),   H5T_NATIVE_INT);
  H5Tinsert (box_id, "hi_k", CHOFFSET(d3, bigend.dataPtr()[0])+2*sizeof(int),   H5T_NATIVE_INT);
  H5Tinsert (box_id, "hi_l", CHOFFSET(d3, bigend.dataPtr()[0])+3*sizeof(int),   H5T_NATIVE_INT);
  H5Tinsert (realvect_id, "x", CHOFFSET(d2, dataPtr()[0]),   H5T_NATIVE_REAL);
  H5Tinsert (realvect_id, "y", CHOFFSET(d2, dataPtr()[0])+sizeof(Real),   H5T_NATIVE_REAL);
  H5Tinsert (realvect_id, "z", CHOFFSET(d2, dataPtr()[0])+2*sizeof(Real),   H5T_NATIVE_REAL);
  H5Tinsert (realvect_id, "u", CHOFFSET(d2, dataPtr()[0])+3*sizeof(Real),   H5T_NATIVE_REAL);
#elif CH_SPACEDIM == 5
  H5Tinsert (intvect_id, "intvecti", CHOFFSET(d1, dataPtr()[0]), H5T_NATIVE_INT);
  H5Tinsert (intvect_id, "intvectj", CHOFFSET(d1, dataPtr()[0])+sizeof(int), H5T_NATIVE_INT);
  H5Tinsert (intvect_id, "intvectk", CHOFFSET(d1, dataPtr()[0])+2*sizeof(int), H5T_NATIVE_INT);
  H5Tinsert (intvect_id, "intvectl", CHOFFSET(d1, dataPtr()[0])+3*sizeof(int), H5T_NATIVE_INT);
  H5Tinsert (intvect_id, "intvectm", CHOFFSET(d1, dataPtr()[0])+4*sizeof(int), H5T_NATIVE_INT);
  H5Tinsert (box_id, "lo_i", CHOFFSET(d3, smallend.dataPtr()[0]), H5T_NATIVE_INT);
  H5Tinsert (box_id, "lo_j", CHOFFSET(d3, smallend.dataPtr()[0])+sizeof(int), H5T_NATIVE_INT);
  H5Tinsert (box_id, "lo_k", CHOFFSET(d3, smallend.dataPtr()[0])+2*sizeof(int), H5T_NATIVE_INT);
  H5Tinsert (box_id, "lo_l", CHOFFSET(d3, smallend.dataPtr()[0])+3*sizeof(int), H5T_NATIVE_INT);
  H5Tinsert (box_id, "lo_m", CHOFFSET(d3, smallend.dataPtr()[0])+4*sizeof(int), H5T_NATIVE_INT);
  H5Tinsert (box_id, "hi_i", CHOFFSET(d3, bigend.dataPtr()[0]),   H5T_NATIVE_INT);
  H5Tinsert (box_id, "hi_j", CHOFFSET(d3, bigend.dataPtr()[0])+sizeof(int),   H5T_NATIVE_INT);
  H5Tinsert (box_id, "hi_k", CHOFFSET(d3, bigend.dataPtr()[0])+2*sizeof(int),   H5T_NATIVE_INT);
  H5Tinsert (box_id, "hi_l", CHOFFSET(d3, bigend.dataPtr()[0])+3*sizeof(int),   H5T_NATIVE_INT);
  H5Tinsert (box_id, "hi_m", CHOFFSET(d3, bigend.dataPtr()[0])+4*sizeof(int),   H5T_NATIVE_INT);
  H5Tinsert (realvect_id, "x", CHOFFSET(d2, dataPtr()[0]),   H5T_NATIVE_REAL);
  H5Tinsert (realvect_id, "y", CHOFFSET(d2, dataPtr()[0])+sizeof(Real),   H5T_NATIVE_REAL);
  H5Tinsert (realvect_id, "z", CHOFFSET(d2, dataPtr()[0])+2*sizeof(Real),   H5T_NATIVE_REAL);
  H5Tinsert (realvect_id, "u", CHOFFSET(d2, dataPtr()[0])+3*sizeof(Real),   H5T_NATIVE_REAL);
  H5Tinsert (realvect_id, "v", CHOFFSET(d2, dataPtr()[0])+4*sizeof(Real),   H5T_NATIVE_REAL);
#elif CH_SPACEDIM == 6
  H5Tinsert (intvect_id, "intvecti", CHOFFSET(d1, dataPtr()[0]), H5T_NATIVE_INT);
  H5Tinsert (intvect_id, "intvectj", CHOFFSET(d1, dataPtr()[0])+sizeof(int), H5T_NATIVE_INT);
  H5Tinsert (intvect_id, "intvectk", CHOFFSET(d1, dataPtr()[0])+2*sizeof(int), H5T_NATIVE_INT);
  H5Tinsert (intvect_id, "intvectl", CHOFFSET(d1, dataPtr()[0])+3*sizeof(int), H5T_NATIVE_INT);
  H5Tinsert (intvect_id, "intvectm", CHOFFSET(d1, dataPtr()[0])+4*sizeof(int), H5T_NATIVE_INT);
  H5Tinsert (intvect_id, "intvectn", CHOFFSET(d1, dataPtr()[0])+5*sizeof(int), H5T_NATIVE_INT);
  H5Tinsert (box_id, "lo_i", CHOFFSET(d3, smallend.dataPtr()[0]), H5T_NATIVE_INT);
  H5Tinsert (box_id, "lo_j", CHOFFSET(d3, smallend.dataPtr()[0])+sizeof(int), H5T_NATIVE_INT);
  H5Tinsert (box_id, "lo_k", CHOFFSET(d3, smallend.dataPtr()[0])+2*sizeof(int), H5T_NATIVE_INT);
  H5Tinsert (box_id, "lo_l", CHOFFSET(d3, smallend.dataPtr()[0])+3*sizeof(int), H5T_NATIVE_INT);
  H5Tinsert (box_id, "lo_m", CHOFFSET(d3, smallend.dataPtr()[0])+4*sizeof(int), H5T_NATIVE_INT);
  H5Tinsert (box_id, "lo_n", CHOFFSET(d3, smallend.dataPtr()[0])+5*sizeof(int), H5T_NATIVE_INT);
  H5Tinsert (box_id, "hi_i", CHOFFSET(d3, bigend.dataPtr()[0]),   H5T_NATIVE_INT);
  H5Tinsert (box_id, "hi_j", CHOFFSET(d3, bigend.dataPtr()[0])+sizeof(int),   H5T_NATIVE_INT);
  H5Tinsert (box_id, "hi_k", CHOFFSET(d3, bigend.dataPtr()[0])+2*sizeof(int),   H5T_NATIVE_INT);
  H5Tinsert (box_id, "hi_l", CHOFFSET(d3, bigend.dataPtr()[0])+3*sizeof(int),   H5T_NATIVE_INT);
  H5Tinsert (box_id, "hi_m", CHOFFSET(d3, bigend.dataPtr()[0])+4*sizeof(int),   H5T_NATIVE_INT);
  H5Tinsert (box_id, "hi_n", CHOFFSET(d3, bigend.dataPtr()[0])+5*sizeof(int),   H5T_NATIVE_INT);
  H5Tinsert (realvect_id, "x", CHOFFSET(d2, dataPtr()[0]),   H5T_NATIVE_REAL);
  H5Tinsert (realvect_id, "y", CHOFFSET(d2, dataPtr()[0])+sizeof(Real),   H5T_NATIVE_REAL);
  H5Tinsert (realvect_id, "z", CHOFFSET(d2, dataPtr()[0])+2*sizeof(Real),   H5T_NATIVE_REAL);
  H5Tinsert (realvect_id, "u", CHOFFSET(d2, dataPtr()[0])+3*sizeof(Real),   H5T_NATIVE_REAL);
  H5Tinsert (realvect_id, "v", CHOFFSET(d2, dataPtr()[0])+4*sizeof(Real),   H5T_NATIVE_REAL);
  H5Tinsert (realvect_id, "w", CHOFFSET(d2, dataPtr()[0])+5*sizeof(Real),   H5T_NATIVE_REAL);
#else
  undefined_dimension!
#endif
