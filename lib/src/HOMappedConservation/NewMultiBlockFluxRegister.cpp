      ...
      for (SideIterator sit; sit.ok(); ++sit)
        {
          ...
          //**Code broken by changes to BaseBlockRegister.  Implicit define of
          //**data is now avoided so components must be passed in.  The 0 below
          //**is the component but is probably not what was wanted.
          //**Suggest rewriting the whole concept of these registers.
          CH_assert(false);
          m_blockCFLocations[iindex]->define(a_domCoar,a_dblCoar, 0);
