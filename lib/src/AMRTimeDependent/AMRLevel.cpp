...
//-----------------------------------------------------------------------
// static
int AMRLevel::finestLevel()
{
  return s_finest_level;
}
//-----------------------------------------------------------------------
...
//-----------------------------------------------------------------------
void
AMRLevel::setSubcycleParams(int  a_currentTimeFactor,
                            int  a_currentStepsLeft,
                            bool a_isFirstSubcycle,
                            bool a_isLastSubcycle)
{
  m_subcycleParams.currentTimeFactor = a_currentTimeFactor;
  m_subcycleParams.currentStepsLeft  = a_currentStepsLeft;
  m_subcycleParams.isFirstSubcycle   = a_isFirstSubcycle;
  m_subcycleParams.isLastSubcycle    = a_isLastSubcycle;
}
//-----------------------------------------------------------------------

//-----------------------------------------------------------------------
const SubcycleParams&
AMRLevel::getSubcycleParams() const
{
  return m_subcycleParams;
}
//-----------------------------------------------------------------------
